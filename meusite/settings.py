...
SECRET_KEY = 'django-insecure-r&rk!*bde)rptqu2ht+$80t35!5^3e=_r(g7b(k$heync_#(3^'

# SECURITY WARNING: don't run with debug turned on in production!
# Quando formos para o ar, isto tem de ser False, mas para testar na Vercel deixa True ou usa esta lógica:
DEBUG = True 
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # },
    {
        ...
        'OPTIONS': {
            'min_length': 4, # Mudei para aceitar passwords de 4 caracteres (antes era 8)
        }
    },
    # {
...
# Configuração de Login (para depois)
LOGIN_URL = 'login'
